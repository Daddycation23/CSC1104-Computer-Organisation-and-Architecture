...
int binaryAddition(int operand_1, int operand_2) 
{
    ...
    while (operand_2 != 0) 
    {
        ...
        carry = (operand_1 & operand_2) << 1;     // please add your code in this line; same as Question (5);

        printf("\nadd carry = %d", carry);        
        // calculating the sum at each bit column, using bitwise XOR.
        sum = (operand_1 ^ operand_2);     // please add your code in this line; same as Question (5);

        printf("\nadd sum = %d", sum);        
        // update operand_1 value by assigning new_operand_1 = sum;
        operand_1 = sum;     // please add your code in this line; same as Question (5);

        printf("\nadd operand_1 = %d", operand_1);        
        // update operand_2 value by assigning new_operand_2 = carry
        operand_2 = carry;     // please add your code in this line; same as Question (5);
...
int binaryMultiplication(int operand_1, int operand_2) 
{
    ...
    {
        if ((operand_2 & 0x1) == 1)    // if the LSB bit of operand_2 is 1
        {
            ...
            product += operand_1;     // please add your code in this line
...
int main() 
{
    int operand_1 = 0, operand_2 = 0, res = 0;
