...
int main()
{
    ...
    // calculate parity bits of data without error; and print out them on screen in C code, 
    // in C code, use ^ for XOR operation.
    // e.g., c1 = D1 ^ D2 
...
// ------------Print out the old parity bits (i.e., check bits). Don't modify codes below ----------------------
    printf("\nC8: %d", C8); 
    printf("\nC4: %d", C4);
    printf("\nC2: %d", C2);
    printf("\nC1: %d", C1);
    ...
    // calculate parity bits of data with 1-bit error; and print out them on screen        
    C1p = error_input[0] ^ error_input[1] ^ error_input[3] ^ error_input[4] ^ error_input[6];
    C2p = error_input[0] ^ error_input[2] ^ error_input[3] ^ error_input[5] ^ error_input[6];
    C4p = error_input[1] ^ error_input[2] ^ error_input[3] ^ error_input[7];
    C8p = error_input[4] ^ error_input[5] ^ error_input[6] ^ error_input[7];

// ------------Print out the new parity bits (i.e., check bits). Don't modify codes below ----------------------
    printf("\nC8p: %d", C8p);
    printf("\nC4p: %d", C4p);
    printf("\nC2p: %d", C2p);
    printf("\nC1p: %d", C1p);
    ...
    // ------------Print out the derived syndrome word. Don't modify codes below ---------------   
    printf("\n==============================");
    printf("\nC''8: %d", fC8);
    printf("\nC''4: %d", fC4);
    printf("\nC''2: %d", fC2);
    printf("\nC''1: %d", fC1);
    printf("\nSyndrome word indicates that position number: %d%d%d%d has an error.",fC8,fC4,fC2,fC1);
